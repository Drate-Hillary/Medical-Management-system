    ...
    <div className='container mx-auto px-4'>
      <div className='max-w-2xl mx-auto'>
        <Card className='border-emerald-900/20'>
          ...
          <CardContent>
            {isRejected ? (
              <div className='bg-red-900/20 border border-red-900/40 rounded p-4 mb-6 flex items-start'>
              ...
              <div className='bg-amber-900/10 border border-amber-900/40 rounded p-4 mb-6 flex items-start'>
